...
class PaynetClient
{
	...
	{
		$this->apikey = $apikey ? $apikey : get_option('payment_paynet_secretkey');
	...
	/*
	* Sunucuda allow_url_fopen seçeneğinin açık olup olmadığını kontrol eder.
	*/
    ...
    /*
	*  cURL extensionının yüklü olup olmadığını kontrol eder.
	*/
